      ...
      <div className="w-full flex flex-col gap-1.5">
        ...
        <div className="relative group">
          ...
          <input
            type={type}
            className={cn(
              "flex w-full rounded-xl border border-gray-200 bg-white px-4 py-3.5 text-sm transition-all shadow-[0_2px_8px_-2px_rgba(0,0,0,0.04)]",
              "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-600 focus-visible:border-transparent",
